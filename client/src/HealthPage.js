...
function HealthPage({ token }) {
  ...
  const typeMeta = {
    ...
    l_arginine_mg:           { label: 'L-Arginine',          unit: 'mg',          group: 'Supplements' },
    l_lysine_mg:             { label: 'L-Lysine',            unit: 'mg',          group: 'Supplements' },
    l_leucine_mg:            { label: 'L-Leucine',           unit: 'mg',          group: 'Supplements' },
    l_isoleucine_mg:         { label: 'L-Isoleucine',        unit: 'mg',          group: 'Supplements' },
    l_valine_mg:             { label: 'L-Valine',            unit: 'mg',          group: 'Supplements' },
    bcaa_mg:                 { label: 'BCAAs',               unit: 'mg',          group: 'Supplements' },
    l_tryptophan_mg:         { label: 'L-Tryptophan',        unit: 'mg',          group: 'Supplements' },
    l_tyrosine_mg:           { label: 'L-Tyrosine',          unit: 'mg',          group: 'Supplements' },
    l_phenylalanine_mg:      { label: 'L-Phenylalanine',     unit: 'mg',          group: 'Supplements' },
    l_methionine_mg:         { label: 'L-Methionine',        unit: 'mg',          group: 'Supplements' },
    l_threonine_mg:          { label: 'L-Threonine',         unit: 'mg',          group: 'Supplements' },
    l_histidine_mg:          { label: 'L-Histidine',         unit: 'mg',          group: 'Supplements' },
    l_cysteine_mg:           { label: 'L-Cysteine',          unit: 'mg',          group: 'Supplements' },
    nac_mg:                  { label: 'NAC',                 unit: 'mg',          group: 'Supplements' },
    l_carnitine_mg:          { label: 'L-Carnitine',         unit: 'mg',          group: 'Supplements' },
    l_citrulline_mg:         { label: 'L-Citrulline',        unit: 'mg',          group: 'Supplements' },
    l_theanine_mg:           { label: 'L-Theanine',          unit: 'mg',          group: 'Supplements' },
    beta_alanine_mg:         { label: 'Beta-Alanine',        unit: 'mg',          group: 'Supplements' },
    taurine_mg:              { label: 'Taurine',             unit: 'mg',          group: 'Supplements' },
    glycine_mg:              { label: 'Glycine',             unit: 'mg',          group: 'Supplements' },
    gaba_mg:                 { label: 'GABA',                unit: 'mg',          group: 'Supplements' },
    five_htp_mg:             { label: '5-HTP',               unit: 'mg',          group: 'Supplements' },
    l_proline_mg:            { label: 'L-Proline',           unit: 'mg',          group: 'Supplements' },
    l_serine_mg:             { label: 'L-Serine',            unit: 'mg',          group: 'Supplements' },
    l_alanine_mg:            { label: 'L-Alanine',           unit: 'mg',          group: 'Supplements' },
    l_aspartate_mg:          { label: 'L-Aspartate',         unit: 'mg',          group: 'Supplements' },
    l_glutamate_mg:          { label: 'L-Glutamate',         unit: 'mg',          group: 'Supplements' },
    coq10_mg:                { label: 'CoQ10',               unit: 'mg',          group: 'Supplements' },
    omega_3_mg:              { label: 'Omega-3',             unit: 'mg',          group: 'Supplements' },
    epa_mg:                  { label: 'EPA',                 unit: 'mg',          group: 'Supplements' },
    dha_mg:                  { label: 'DHA',                 unit: 'mg',          group: 'Supplements' },
    alpha_lipoic_acid_mg:    { label: 'Alpha Lipoic Acid',   unit: 'mg',          group: 'Supplements' },
    melatonin_mg:            { label: 'Melatonin',           unit: 'mg',          group: 'Supplements' },
    ashwagandha_mg:          { label: 'Ashwagandha',         unit: 'mg',          group: 'Supplements' },
    curcumin_mg:             { label: 'Curcumin',            unit: 'mg',          group: 'Supplements' },
    collagen_g:              { label: 'Collagen',            unit: 'g',           group: 'Supplements' },
    glucosamine_mg:          { label: 'Glucosamine',         unit: 'mg',          group: 'Supplements' },
    chondroitin_mg:          { label: 'Chondroitin',         unit: 'mg',          group: 'Supplements' },
    resveratrol_mg:          { label: 'Resveratrol',         unit: 'mg',          group: 'Supplements' },
    quercetin_mg:            { label: 'Quercetin',           unit: 'mg',          group: 'Supplements' },
    berberine_mg:            { label: 'Berberine',           unit: 'mg',          group: 'Supplements' },
    inositol_mg:             { label: 'Inositol',            unit: 'mg',          group: 'Supplements' },
    dhea_mg:                 { label: 'DHEA',                unit: 'mg',          group: 'Supplements' },
    silymarin_mg:            { label: 'Milk Thistle',        unit: 'mg',          group: 'Supplements' },
    valerian_mg:             { label: 'Valerian',            unit: 'mg',          group: 'Supplements' },
    elderberry_mg:           { label: 'Elderberry',          unit: 'mg',          group: 'Supplements' },
    hyaluronic_acid_mg:      { label: 'Hyaluronic Acid',     unit: 'mg',          group: 'Supplements' },
    phosphatidylserine_mg:   { label: 'Phosphatidylserine',  unit: 'mg',          group: 'Supplements' },
    astaxanthin_mg:          { label: 'Astaxanthin',         unit: 'mg',          group: 'Supplements' },
    probiotics_bcfu:         { label: 'Probiotics',          unit: 'B CFU',       group: 'Supplements' },
    saw_palmetto_mg:         { label: 'Saw Palmetto',        unit: 'mg',          group: 'Supplements' },
    st_johns_wort_mg:        { label: "St. John's Wort",     unit: 'mg',          group: 'Supplements' },
    echinacea_mg:            { label: 'Echinacea',           unit: 'mg',          group: 'Supplements' },
    ginseng_mg:              { label: 'Ginseng',             unit: 'mg',          group: 'Supplements' },
    maca_mg:                 { label: 'Maca',                unit: 'mg',          group: 'Supplements' },
    spirulina_mg:            { label: 'Spirulina',           unit: 'mg',          group: 'Supplements' },
    chlorella_mg:            { label: 'Chlorella',           unit: 'mg',          group: 'Supplements' },
    matcha_mg:               { label: 'Matcha',              unit: 'mg',          group: 'Supplements' },
    green_tea_extract_mg:    { label: 'Green Tea Extract',   unit: 'mg',          group: 'Supplements' },
    pycnogenol_mg:           { label: 'Pycnogenol',          unit: 'mg',          group: 'Supplements' },
    lycopene_mg:             { label: 'Lycopene',            unit: 'mg',          group: 'Supplements' },
    lutein_mg:               { label: 'Lutein',              unit: 'mg',          group: 'Supplements' },
    zeaxanthin_mg:           { label: 'Zeaxanthin',          unit: 'mg',          group: 'Supplements' },
    shilajit_mg:             { label: 'Shilajit',            unit: 'mg',          group: 'Supplements' },
    lions_mane_mg:           { label: "Lion's Mane",         unit: 'mg',          group: 'Supplements' },
    reishi_mg:               { label: 'Reishi',              unit: 'mg',          group: 'Supplements' },
    cordyceps_mg:            { label: 'Cordyceps',           unit: 'mg',          group: 'Supplements' },
    chaga_mg:                { label: 'Chaga',               unit: 'mg',          group: 'Supplements' },
    turkey_tail_mg:          { label: 'Turkey Tail',         unit: 'mg',          group: 'Supplements' },
