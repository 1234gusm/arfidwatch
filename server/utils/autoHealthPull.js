...
const HAE_TYPE_REMAP = {
  ...
  blood_pressure_systolic_mm_hg:      'blood_pressure_systolic_mmhg',
  blood_pressure_diastolic_mm_hg:     'blood_pressure_diastolic_mmhg',
  oxygen_saturation_percent:          'oxygen_saturation_percent',
  oxygen_saturation:                  'oxygen_saturation_percent',
  blood_oxygen:                       'oxygen_saturation_percent',
  peripheral_perfusion_index:         'peripheral_perfusion_index_percent',
